...
def makefile():
	...
	password = getpass('Please enter your password (Just type. Its hidden!):')
	...
	print ('\nCreate shortcut for quiet.exe-->Properties-->Target-->\nAdd nbrclogin.exe to end-->add the shortcut to Startup Programs\nfor autologin.')
	print ('For logging out double click logout.bat')
	print ('Confused? For details, read the documentation attached. :)\n')
